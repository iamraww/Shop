(function (a) {
    a.superfish = {}, a.superfish.o = [], a.superfish.op = {}, a.superfish.defaults = {
        ...
        return this.each(function () {
            var f = this.serial = a.superfish.o.length, g = a.extend({}, a.superfish.defaults, b);
        ...
        hideSuperfishUl: function () {
            ...
            var b = a.superfish.op, c = this.addClass(b.hoverClass).find(">ul:hidden").css("visibility", "visible");
...
(function (a) {
    a.fn.supposition = function () {
        var b = a(window), c = function (a) {
            ...
            this.css({marginTop: "", marginLeft: ""}), this.removeClass("sfRight")
        }, f = function () {
            this.each(function () {
                var d = a(this);
                d.css("display", "block");
                var e = d.width(), f = d.parents("ul").width(), g = b.width() + c("x"), h = d.offset().left + e + 6;
                var o = d.offset();
                ...
                (d.parents('.sub-menu').hasClass('sfRight') || h > g) && (d.css("margin-left", (d.parents("ul").length == 1 ? g - h : -(e + f))), d.addClass("sfRight"), d.closest("li").closest("ul").addClass("sfRight")), d.css("display", "none")
            })
        };
        return this.each(function () {
            var b = a.superfish.o[this.serial], c = b.onInit, g = b.onBeforeShow, h = b.onHide;
