var emailLabel = document.querySelector('#loginEmailLabel'), email = document.querySelector('#loginEmail'),
    usernameLabel = document.querySelector('#UsernameLabel'), username = document.querySelector('#username'),
    passwordLabel = document.querySelector('#loginPasswordLabel'), password = document.querySelector('#loginPassword'),
    confirmPasswordLabel = document.querySelector('#ConfirmPasswordLabel'), confirmPwd = document.querySelector('#confirmPwd'),
